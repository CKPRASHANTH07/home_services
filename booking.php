        ...
        <div class="card-body">
            ...
            <form action="scripts/bookhall.php" method="post">
                ...
                <div class="form-group">
                    ...
                    <input id="fname" name="fname" type="text" class="form-control" placeholder="Name" required>
                </div>

                <div class="form-group">
                    <label for="">MAIL ID</label>
                    <input id="lname" name="lname" type="text" class="form-control" placeholder="Mail Id" required>
                </div>
